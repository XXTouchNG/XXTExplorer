...
@implementation XXTESwipeButton
...
{
    XXTESwipeButton * button = [self buttonWithType:UIButtonTypeCustom];
...
-(BOOL) callXXTESwipeConvenienceCallback: (XXTESwipeTableCell *) sender
{
    if (_callback) {
