...
- (CGRect)boundsForView {
    ...
    CGFloat maxWidth = (CGFloat) MAX(fabs(CGRectGetMinX(bounds)), fabs(CGRectGetMaxX(bounds)));
    CGFloat maxHeight = (CGFloat) MAX(fabs(CGRectGetMinY(bounds)), fabs(CGRectGetMaxY(bounds)));
