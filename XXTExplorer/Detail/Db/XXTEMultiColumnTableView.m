...
@implementation XXTEMultiColumnTableView
...
- (void)loadHeaderData
{
    ...
    for (int i = 0; i < [self numberOfColumns] ; i++) {
        ...
        XXTEDbTableColumnHeaderSortType type = [self.sortStatusDict[[self columnTitleForColumn:i]] integerValue];
...
{
    XXTEDbTableColumnHeader *header = (XXTEDbTableColumnHeader *)gesture.view;
    NSString *string = header.label.text;
    XXTEDbTableColumnHeaderSortType currentType = [self.sortStatusDict[string] integerValue];
    XXTEDbTableColumnHeaderSortType newType ;
    
    switch (currentType) {
        case XXTEDbTableColumnHeaderSortTypeNone:
            newType = XXTEDbTableColumnHeaderSortTypeAsc;
            break;
        case XXTEDbTableColumnHeaderSortTypeAsc:
            newType = XXTEDbTableColumnHeaderSortTypeDesc;
            break;
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView != self.leftTableView) {
        ...
        XXTEDbTableContentCell *cell = [XXTEDbTableContentCell cellWithTableView:tableView
        ...
        XXTEDbTableLeftCell *cell          = [XXTEDbTableLeftCell cellWithTableView:tableView];
        cell.contentView.backgroundColor = backgroundColor;
