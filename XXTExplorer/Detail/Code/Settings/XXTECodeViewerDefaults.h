...
#ifndef XXTECodeViewerDefaults_h
#define XXTECodeViewerDefaults_h

static NSString * const XXTECodeViewerFontName = @"XXTECodeViewerFontName"; // NSString
