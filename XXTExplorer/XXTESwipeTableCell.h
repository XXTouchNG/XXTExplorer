...
/** Transition types */
typedef NS_ENUM(NSInteger, XXTESwipeTransition) {
    XXTESwipeTransitionBorder = 0,
    XXTESwipeTransitionStatic,
    XXTESwipeTransitionDrag,
    XXTESwipeTransitionClipCenter,
    XXTESwipeTransitionRotate3D
};

/** Compatibility with older versions */
#define XXTESwipeTransition3D XXTESwipeTransitionRotate3D
#define XXTESwipeStateSwippingLeftToRight XXTESwipeStateSwipingLeftToRight
#define XXTESwipeStateSwippingRightToLeft XXTESwipeStateSwipingRightToLeft

/** Swipe directions */
typedef NS_ENUM(NSInteger, XXTESwipeDirection) {
    XXTESwipeDirectionLeftToRight = 0,
    XXTESwipeDirectionRightToLeft
};

/** Swipe state */
typedef NS_ENUM(NSInteger, XXTESwipeState) {
    XXTESwipeStateNone = 0,
    XXTESwipeStateSwipingLeftToRight,
    XXTESwipeStateSwipingRightToLeft,
    XXTESwipeStateExpandingLeftToRight,
    XXTESwipeStateExpandingRightToLeft,
};
...
typedef NS_ENUM(NSInteger, XXTESwipeEasingFunction) {
    XXTESwipeEasingFunctionLinear = 0,
    XXTESwipeEasingFunctionQuadIn,
    XXTESwipeEasingFunctionQuadOut,
    XXTESwipeEasingFunctionQuadInOut,
    XXTESwipeEasingFunctionCubicIn,
    XXTESwipeEasingFunctionCubicOut,
    XXTESwipeEasingFunctionCubicInOut,
    XXTESwipeEasingFunctionBounceIn,
    XXTESwipeEasingFunctionBounceOut,
    XXTESwipeEasingFunctionBounceInOut
};

/**
 * Swipe animation settings
 **/
@interface XXTESwipeAnimation : NSObject
/** Animation duration in seconds. Default value 0.3 */
@property (nonatomic, assign) CGFloat duration;
/** Animation easing function. Default value EaseOutBounce */
@property (nonatomic, assign) XXTESwipeEasingFunction easingFunction;
 ...
 * Swipe settings
 **/
@interface XXTESwipeSettings: NSObject
/** Transition used while swiping buttons */
@property (nonatomic, assign) XXTESwipeTransition transition;
 ...
 **/
@interface XXTESwipeExpansionSettings: NSObject
 ...
 */
@protocol XXTESwipeTableCellDelegate <NSObject>
 ...
 * @param usingDelegate if YES new buttons will be fetched using the XXTESwipeTableCellDelegate. Otherwise new buttons will be fetched from leftButtons/rightButtons properties.
 */
