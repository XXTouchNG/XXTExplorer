...
-(instancetype) initWithButtons:(NSArray*) buttonsArray direction:(XXTESwipeDirection) direction differentWidth:(BOOL) differentWidth
{
...
-(void) createSwipeViewIfNeeded
{
    ...
    if (!_leftView && _leftButtons.count > 0) {
        _leftView = [[XXTESwipeButtonsView alloc] initWithButtons:_leftButtons direction:XXTESwipeDirectionLeftToRight differentWidth:_allowsButtonsWithDifferentWidth];
        _leftView.cell = self;
    ...
    if (!_rightView && _rightButtons.count > 0) {
        _rightView = [[XXTESwipeButtonsView alloc] initWithButtons:_rightButtons direction:XXTESwipeDirectionRightToLeft differentWidth:_allowsButtonsWithDifferentWidth];
...
-(void) panHandler: (UIPanGestureRecognizer *)gesture
{
    ...
    if (gesture.state == UIGestureRecognizerStateBegan) {
        ...
        XXTESwipeButtonsView * expansion = _activeExpansion;
        if (expansion) {
