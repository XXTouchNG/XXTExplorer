 ...
 */
typedef enum {
    XXTELuaArgumentTypeNone,
    XXTELuaArgumentTypeString,
    XXTELuaArgumentTypeNumber,
    XXTELuaArgumentTypeObject,
    XXTELuaArgumentTypeBoolean,
    XXTELuaArgumentTypeMultiple,
    XXTELuaArgumentTypeTable,
    XXTELuaArgumentTypeLightObject
} XXTELuaArgumentType;

/**
 * Lua Interpreter class. Holds the LUA state and releases it when deallocated.
 */
@interface XXTELuaInterpreter : NSObject
