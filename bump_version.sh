...
plutil -remove "items.1" "XXTExplorer/Supporting Files/SettingsPro.bundle/About.plist"
...
plutil -replace "CFBundleShortVersionString" -string "${BVER}" "XXTExplorer/Supporting Files/Base.lproj/InfoStore.plist"
plutil -replace "DAEMON_VERSION" -string "${BVER}" "XXTExplorer/Defines/XXTEAppDefinesStore.plist"
...
v${BVER}</string><key>value</key><string>https://82flex.com
2014-${YEAR} © Zheng Wu
...
plutil -insert "items.6" -xml "<dict><key>cell</key><string>Button</string><key>label</key><string>Mail Feedback</string><key>action</key><string>SendMail:</string><key>args</key><dict><key>subject</key><string>[Feedback] XXTouch Editor v${BVER}</string><key>toRecipients</key><array><string>i.82@me.com</string></array><key>ccRecipients</key><array><string>i.82@qq.com</string></array></dict><key>icon</key><string>res/XXTEAboutIconMail.png</string><key>iconRenderingMode</key><string>AlwaysTemplate</string></dict>" "XXTExplorer/Supporting Files/Settings.bundle/About.plist"
